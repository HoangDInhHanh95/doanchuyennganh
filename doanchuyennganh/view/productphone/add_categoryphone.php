<?php
    include '../admin/slider_menu.php';// có biên conn
        ...
        if(isset($_POST['submidcate']))
        {
            $thuonghieu = $_POST['thuonghieu']; 
            $sql = "INSERT INTO `categoryphoneandtablet`(`thuonghieu`) VALUES ('$thuonghieu')";
...
<div class="form_cate">
    <form method="POST">
        <div class="panel panel-info">
                ...
                <button type="submit" class= "btn btn-primary" name="submidcate" >Thêm mới</button>
                </div>
        </div>  
    </form>
</div>
