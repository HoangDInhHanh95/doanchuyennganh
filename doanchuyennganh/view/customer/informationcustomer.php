...
<?php
   ...
   {
       $id = $_GET['id'];
       $produc = mysqli_query($conn,"SELECT * FROM `customer` WHERE idcustomer = $id");
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <thead>
                            ...
                            <tr>
                                <td>Địa chỉ</td>
                                <td><?php echo $pro['diachi'] ?></td>
                            </tr>
                            <tr>
                            <td style="text-align: center;" colspan="2">
                                <a href="logout.php" class= "btn btn-info">Đăng Xuất</a>
                                <a href="edit_information.php?id=<?php echo $pro['idcustomer'] ?>" class="btn btn-primary">Cập nhật thông tin</a>
                                </td>
                            </tr>
                        </thead>
                    </table>
